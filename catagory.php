...
<?php
		...
		$rs=$gigs->uniq_gigs_list('catagory_id',$catagory_id);
		$i=0;                
?>
...
<tr height="40" >
<td width="10%" class="style1">I will </td>
<td width="59%" align="right"><input type="text" value="" size="30" name="gigs_title" id="gigs_title" class="text-title"></td>
<td width="11%" class="style1">for <?php echo SITE_AMMOUNT;?></td>
<td width="20%"><input type="image" src="images/btn-2-continue-gray.png" class="btn-update" alt="Update"></td>
</tr>                        
</table>
</form>
</div>
