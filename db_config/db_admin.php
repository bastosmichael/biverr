...
/* End of table  list*/
	...
	function admin_login($user_primary_email,$user_password)
	{
	...
	function admin_list()
	{
	$sql="select * from ninerr_admin ";
	$rs=mysql_query($sql);
	return $rs;
	}
	function uniq_admin_list($name,$value)
	{
	$sql="select * from ninerr_admin where ".$name."='".$value."'";
	$rs=mysql_query($sql);
	return $rs;
	}
	...
	{
	$sql="DELETE FROM `ninerr_admin` WHERE user_id='".$id."'";
	$rs=mysql_query($sql);
	return $rs;
	}
