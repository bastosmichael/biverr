...
/*-----------Full table  list-----------*/
	function gigs_list()
	{
	$sql="select * from ninerr_gigs  where gigs_status='Active'";
	$rs=mysql_query($sql);
	return $rs;
	}
...
/*----------- Uniq table  list-----------*/
	...
	{
	$sql="select * from ninerr_gigs where ".$name."='".$value."' and gigs_status='Active'";
	$rs=mysql_query($sql);
	return $rs;
	}
...
/*----------- Uniq table  list-----------*/
	...
	function uniq_gigs_list_user($name,$value)
	{
...
/*----------- Uniq table  list with limit offset-----------*/
	...
	{
	$sql="select * from ninerr_gigs where ".$name."='".$value."'  and gigs_status='Active' LIMIT $startpoint,$perpage";
	$rs=mysql_query($sql);
	return $rs;
	}
	
/* End of Uniq table  list*/
	function uniq_gigs_list_limit_like($name,$value,$startpoint,$perpage)
	{
	$sql="select * from ninerr_gigs where   gigs_status='Active' and ".$name." LIKE '%".$value."%'   LIMIT $startpoint,$perpage";
	$rs=mysql_query($sql);
	return $rs;
	}
/*----------- Uniq table  list double-----------*/
	...
	{
	$sql="select * from ninerr_gigs where ".$name1."='".$value1."' and ".$name2."='".$value2."'  and gigs_status='Active' ";
	$rs=mysql_query($sql);
	return $rs;
	}
...
/* End of Uniq table  list*/
	...
	{
	$sql="select * from ninerr_gigs where ".$name."='".$value."'  and gigs_status='Active' ORDER BY ".$order_name." ".$order_type." LIMIT $startpoint,$perpage";
	$rs=mysql_query($sql);
	return $rs;
	}
...
/*----------- Search  table  list-----------*/
	...
	{
	$sql="SELECT * FROM ninerr_gigs where   gigs_status='Active' and gigs_title LIKE '%".$value."%' or gigs_description LIKE '%".$value."%' or gigs_location LIKE '%".$value."%'";
	$rs=mysql_query($sql);
	return $rs;
	}
