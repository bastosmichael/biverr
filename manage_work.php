...
<?php
	...
	if($_REQUEST['st'])
	{
		$rs=$order_payment->uniq_order_payment_list_double('seller_id',$_SESSION['user_id'],'order_status',$_REQUEST['st']);
	}
	else
	{
		$rs=$order_payment->uniq_order_payment_list('seller_id',$_SESSION['user_id']);
	}
        ...
        <div class="tweet_bx">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
           <!-- <tr>
            ...
            <!--<tr height="50">
              <td width="12%"><a href="manage_work.php">All Status </a></td>
              <td width="11%"><a href="manage_work.php?st=pending">Pending</a></td>
              <td width="14%"><a href="manage_work.php?st=compleated">Completed</a></td>
			  <td width="14%"><a href="manage_work.php?st=cancelled">Cancelled</a></td>
              <td width="49%"><a href="manage_work.php?st=review">Review</a></td>
            </tr>-->
          </table>
		  <?php
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr bgcolor="#F1F1F1" height="30">
             ...
             <!-- <td width="9%" align="center"><strong>Review</strong></td>-->
            </tr>
			<tr  >
 ...
 $data_review=mysql_num_rows($rs_review);
    ...
    ?>
            <tr  >
		      ...
		      <td width="13%" ><!--<img src="images/actions.png" align="middle" onclick="javascript:location.href='edit_manage_order.php?orderid=<?php echo $data['order_id'];  ?>'" style="cursor:pointer;" />-->
			  <?php
			  if($data['order_status']!="compleated")
			  {
			  ?>
			  <a href="edit_manage_order.php?orderid=<?php echo $data['order_id'];  ?>">Cancel</a> 
			  <?php
			  }
			  ?>
			  </td>
			  <td width="12%" ><!--<img src="images/actions.png" align="middle" onclick="javascript:location.href='edit_manage_order.php?orderid=<?php echo $data['order_id'];  ?>'" style="cursor:pointer;" />-->
			  <?php
			  if($data['order_status']!="compleated" && $data['order_status']!="cancelled")
			  {
			  ?><a href="deliver_work.php?orderid=<?php echo base64_encode($data['order_id']);  ?>" >Deliver Work</a>
			  <?php
			  }
			  else
			  {
