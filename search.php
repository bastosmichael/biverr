...
<?php
		...
		$rs=$gigs->gigs_search_list($query);
		$i=0;
?>
...
<b>Search again</b>
<br />
<form method="post" id="create_gigs" enctype="multipart/form-data"  action="search.php">
<table width="100%" border="0" cellspacing="0" cellpadding="0"  >
<tr height="40" >
<td width="10%" class="style1">&nbsp;</td>
<td width="70%" align="right"><input type="text" value="<?php echo $query; ?>" size="30" name="query" id="gigs_title" class="text-title"><input height="32" type="image" src="images/btn-go.gif" class="btn-update" alt="Update"></td>
...
<div class="results-bar" >
  <span > Search Results for <strong><?php echo $query; ?></strong></span>
